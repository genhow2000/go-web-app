...
func (s *ProductSeeder) Run() error {
	...
	products := []struct {
	...
	}{
		{
			...
			Stock:        50,
			ImageURL:     func() *string { v := "https://images.pexels.com/photos/788946/pexels-photo-788946.jpeg?auto=compress&cs=tinysrgb&w=400"; return &v }(),
			IsFeatured:   true,
			IsOnSale:     true,
			MerchantID:   1,
		},
		{
			...
			Stock:        30,
			ImageURL:     func() *string { v := "https://images.pexels.com/photos/1181671/pexels-photo-1181671.jpeg?auto=compress&cs=tinysrgb&w=400"; return &v }(),
			IsFeatured:   true,
			IsOnSale:     false,
			MerchantID:   1,
		},
		{
			...
			Stock:        100,
			ImageURL:     func() *string { v := "https://images.pexels.com/photos/1043474/pexels-photo-1043474.jpeg?auto=compress&cs=tinysrgb&w=400"; return &v }(),
			IsFeatured:   false,
			IsOnSale:     true,
			MerchantID:   1,
		},
		{
			...
			Stock:        80,
			ImageURL:     func() *string { v := "https://images.pexels.com/photos/1598505/pexels-photo-1598505.jpeg?auto=compress&cs=tinysrgb&w=400"; return &v }(),
			IsFeatured:   true,
			IsOnSale:     false,
			MerchantID:   1,
		},
		{
			...
			Stock:        60,
			ImageURL:     func() *string { v := "https://images.pexels.com/photos/3373736/pexels-photo-3373736.jpeg?auto=compress&cs=tinysrgb&w=400"; return &v }(),
			IsFeatured:   false,
			IsOnSale:     true,
			MerchantID:   1,
		},
		{
			...
			Stock:        25,
			ImageURL:     func() *string { v := "https://images.pexels.com/photos/302899/pexels-photo-302899.jpeg?auto=compress&cs=tinysrgb&w=400"; return &v }(),
			IsFeatured:   true,
			IsOnSale:     false,
			MerchantID:   1,
		},
		{
			...
			Stock:        200,
			ImageURL:     func() *string { v := "https://images.pexels.com/photos/143133/pexels-photo-143133.jpeg?auto=compress&cs=tinysrgb&w=400"; return &v }(),
			IsFeatured:   false,
			IsOnSale:     true,
			MerchantID:   1,
		},
		{
			...
			Stock:        150,
			ImageURL:     func() *string { v := "https://images.pexels.com/photos/159711/books-bookstore-book-reading-159711.jpeg?auto=compress&cs=tinysrgb&w=400"; return &v }(),
			IsFeatured:   true,
			IsOnSale:     false,
			MerchantID:   1,
		},
